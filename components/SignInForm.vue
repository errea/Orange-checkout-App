...
<div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0 dark:bg-gray-800">
    <div class="justify-center top-2">
      <form novalidate class="w-full max-w-lg bg-white shadow-md rounded px-8 pt-6 pb-8 mt-12" @submit.prevent="loginUserSubmitForm"
  >
    <div class="mb-6">
  ...
  <div class="w-full mb-6">
      ...
      <input v-model="remember" class="mr-2 mt-1 leading-tight" type="checkbox" required>
