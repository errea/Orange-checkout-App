		...
		<div class="container mx-auto mt-10">
			<div class="flex shadow-md my-10">
				<div class="w-full dark:bg-gray-50 px-10 py-10">
					...
					<div class="mt-6 mb-4 font-semibold text-2xl">
						<h4>Add new item to Shopping List </h4>
					</div>
					<div class="col">
						<div class="font-semibold">
							...
							<input
								v-model="itemName"
								type="text"
								class="text-gray-900 ring-gray-900 ring-opacity-5 placeholder-gray-400 appearance-none bg-white rounded-md block w-1/2 px-3 py-2 border border-transparent shadow ring-1 sm:text-sm focus:border-teal-500 focus:ring-teal-500 focus:outline-none"
							>
						</div>
