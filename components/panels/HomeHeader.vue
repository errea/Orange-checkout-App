<template>
     <!-- Section 1 -->
    <section class="px-2 py-32 bg-white md:px-0 bg-gray-50">
      ...
      <div class="w-full md:w-1/2 md:px-3">
        <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          ...
          <div class="relative flex flex-col sm:flex-row sm:space-x-4">
            <NuxtLink to="/user/stepper" class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
              Click Here to Checkout Page
